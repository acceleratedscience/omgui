...
def __generate_url(chart_type: t.ChartType, input_data: t.ChartDataType, **kwargs):
    """
    Generate URL to render chart.
    """
    query: dict[str, any] = kwargs
...
def line(
    ...
    """
    # Compile Plotly data dict
    chart_data = prep.line(input_data, horizontal=horizontal)
