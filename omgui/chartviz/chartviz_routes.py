...
from omgui.chartviz.util import deep_merge, is_dates, hash_data
...
@chartviz_router.get("/data", summary="List available sample data files")
...
@chartviz_router.get("/data/{filename}", summary="Render a chart from JSON data")
